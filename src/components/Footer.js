        ...
        <CDBBox display="flex" justifyContent="between" className="flex-wrap">
          <CDBBox>
            ...
            <CDBBox display="flex" className="mt-4">
              <CDBBtn flat color="dark">
                <CDBIcon fab icon="fa-brands fa-discord" />
              </CDBBtn>
          ...
          <CDBBox>
            ...
            <CDBBox flex="column" style={{ cursor: 'pointer', padding: '0' }}>
              ...
              <CDBFooterLink href="/">Whitepaper</CDBFooterLink>
              <CDBFooterLink href="/">produit 1</CDBFooterLink>
              <CDBFooterLink href="/">produit 2</CDBFooterLink>
            </CDBBox>
          </CDBBox>
        </CDBBox>
